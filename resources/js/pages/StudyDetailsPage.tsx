    ...
    const load = async () => {
      ...
      if (testTemp) {
        setData([
          ...
          { icon: 'pending_actions', title: 'Giới hạn', value: 'Không giới hạn' },
      ...
      { loading
        ...
        : <>
          <div className='bg-white p-4 rounded-lg shadow'>
            ...
            {/* @ts-ignore */}
            <Button LinkComponent={Link} to={`/test/${test.code}`} variant='contained' fullWidth className='mt-4'>Băt đầu làm bài</Button>
          </div>
